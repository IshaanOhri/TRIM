...
let title = document.getElementById('newURLTitle');
let newURL = document.getElementById('newURL');
let newURLView = document.getElementById('newURLView');
let copyLink = document.getElementById('copyLink');
let url = document.getElementById('url');
let shortHand = document.getElementById('shortHand');
let custom = document.getElementById('custom');
let urlSnackbar = document.getElementById('urlSnackbar');
let shortHandSnackbar = document.getElementById('shortHandSnackbar');

function hideCustomDomain() {
	if (shortHandView.style.display === 'block') {
		shortHandView.style.display = 'none';
	} else {
		shortHandView.style.display = 'block';
	}

	if (domain.style.display === 'block') {
...
function copyShortLink() {
	...
	clipboard.className = 'show';
	setTimeout(function () {
		clipboard.className = clipboard.className.replace('show', '');
	}, 3000);
	deselectAll();
}
...
function displayShortLink() {
	...
	newURLView.style.display = 'block';
...
async function shortenURL() {
	...
	let customValue = custom.checked;
	let shortHandValue;
	...
	if (customValue) {
		shortHandValue = shortHand.value;
		if (urlValue != '' && shortHandValue == '') {
			if (mobile) {
